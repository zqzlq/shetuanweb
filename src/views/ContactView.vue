<template>
  <div class="page-view">
    <div class="container">
      <div class="page-hero">
        <h1>联系我们</h1>
        <p class="page-subtitle">有任何问题或合作意向，欢迎随时与我们联系</p>
      </div>
      ...
      <div class="contact-layout reveal">
          ...
          <PaperCard>
            ...
            <div class="social-links">
              ...
              <div class="social-icons">
                ...
                <a href="#" title="微信" class="social-icon">
        ...
        <div class="contact-form">
          <PaperCard>
            <h3>给我们留言</h3>
            <p class="form-hint">填写以下表单，我们会尽快回复你</p>
            ...
            <div v-if="submitResult && submitResult.success" class="submit-success">
              ...
              <button class="btn btn-outline" @click="resetForm">继续留言</button>
            </div>
            ...
            <form v-else @submit.prevent="submitForm">
              ...
              <div class="form-grid">
                ...
                <label :class="{ error: errors.subject }">
                  <span>主题 <em>*</em></span>
                  <input v-model="form.subject" type="text" placeholder="留言主题" @blur="validateField('subject')" />
                  <small v-if="errors.subject" class="error-msg">{{ errors.subject }}</small>
                </label>
                <label class="full" :class="{ error: errors.message }">
                  <span>留言内容 <em>*</em></span>
                  <textarea v-model="form.message" rows="5" placeholder="请输入你的留言内容..." @blur="validateField('message')"></textarea>
...
const rules = {
  ...
  subject: [
    { test: (v) => v.trim(), msg: '请填写主题' },
  ],
  message: [
    { test: (v) => v.trim(), msg: '请填写留言内容' },
    { test: (v) => v.trim().length >= 5, msg: '留言内容至少 5 个字' },
  ],
}
