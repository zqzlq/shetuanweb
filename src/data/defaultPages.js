  ...
  blog: {
    ...
    content: {
      ...
      posts: [
        ...
        { title: 'Vue 3 组合式 API 实战心得', excerpt: '从 Options API 迁移到 Composition API 的踩坑记录与最佳实践', category: '技术', date: '2024-09-22', readTime: '10 分钟', link: '' },
        { title: '社团招新复盘：我们做对了什么', excerpt: '2024 秋季招新的完整复盘，从宣传到筛选的全流程分享', category: '活动', date: '2024-09-10', readTime: '6 分钟', link: '' },
        { title: 'Rust 在后端开发中的初体验', excerpt: '记录我们用 Rust 重写雨记协作板后端的全过程与性能对比', category: '技术', date: '2024-08-18', readTime: '15 分钟', link: '' },
        { title: '如何写好一份技术文档', excerpt: '从结构到语言，分享社团内部技术文档的写作规范', category: '开源', date: '2024-07-25', readTime: '7 分钟', link: '' },
        { title: '设计走查清单：从像素到体验', excerpt: '星绘组在项目中积累的设计走查方法与常见问题清单', category: '设计', date: '2024-07-10', readTime: '9 分钟', link: '' },
        { title: '社团第一次线下黑客松回顾', excerpt: '48 小时极限开发，6 支队伍产出了什么？', category: '活动', date: '2024-06-20', readTime: '5 分钟', link: '' },
      ],
